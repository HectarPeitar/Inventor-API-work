...
#if !defined(AFX_CLIENTGRAPHICS_H__F863E9AF_7D32_11D4_9362_00108302B954__INCLUDED_)
#define AFX_CLIENTGRAPHICS_H__F863E9AF_7D32_11D4_9362_00108302B954__INCLUDED_
...
/*--------------------- CClientGraphicsApp class declaration -------------------------------*/

class CClientGraphicsApp : public CWinApp
{
public:
	CClientGraphicsApp();
...
// Overrides
	...
	//{{AFX_VIRTUAL(CClientGraphicsApp)
	public:
	virtual BOOL InitInstance();
	//}}AFX_VIRTUAL

	//{{AFX_MSG(CClientGraphicsApp)
...
/*--------------------- CClientGraphicsFactory class declaration -------------------------------*/

/*
 * The COM Class Factory class that is used by COM at CoCreation time to create the
 * CClientGraphics object through its CreateInstance method. The CClientGraphics object
 * is the object that is the first point of communication with Rubicon.
 */

class CClientGraphicsFactory : public IClassFactory
{
...
#endif // !defined(AFX_CLIENTGRAPHICS_H__F863E9AF_7D32_11D4_9362_00108302B954__INCLUDED_)
