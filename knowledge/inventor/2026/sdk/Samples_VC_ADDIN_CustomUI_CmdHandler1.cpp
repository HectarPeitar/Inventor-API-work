...
//-----------------------------------------------------------------------------
//----- CmdHandler1.cpp : Implementation of CCmdHandler1
//-----------------------------------------------------------------------------
#include "StdAfx.h"
...
//-----------------------------------------------------------------------------
STDMETHODIMP CCmdHandler1::OnExecute (NameValueMap *context) {

	CWindow win;		
	win.Attach(m_ParentHwnd);
	win.MessageBox(_T("You clicked Command1 button"), _T("Command1 Implementation"));	
	return S_OK;
}
