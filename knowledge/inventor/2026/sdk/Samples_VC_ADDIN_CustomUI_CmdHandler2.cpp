...
//-----------------------------------------------------------------------------
//----- CmdHandler2.cpp : Implementation of CCmdHandler2
//-----------------------------------------------------------------------------
#include "StdAfx.h"
...
//-----------------------------------------------------------------------------
STDMETHODIMP CCmdHandler2::OnExecute (NameValueMap* context) {

	CWindow win;		
	win.Attach(m_ParentHwnd);
	win.MessageBox(_T("You clicked Command2 button"), _T("Command2 Implementation"));	
	return S_OK;
}