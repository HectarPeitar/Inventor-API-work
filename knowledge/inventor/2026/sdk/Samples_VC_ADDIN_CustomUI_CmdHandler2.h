...
//-----------------------------------------------------------------------------
//----- CmdHandler2.h : Declaration of the CCmdHandler2
//-----------------------------------------------------------------------------
#ifndef _CmdHandler2_h_
#define _CmdHandler2_h_

#include "resource.h"
#include "CmdHandler.h"

//-----------------------------------------------------------------------------
class CCmdHandler2 : public CCmdHandler
{
...
public:
	...
	STDMETHOD(OnExecute) (NameValueMap* context) ;

} ;

//-----------------------------------------------------------------------------
#endif //----- _CmdHandler2_h_
