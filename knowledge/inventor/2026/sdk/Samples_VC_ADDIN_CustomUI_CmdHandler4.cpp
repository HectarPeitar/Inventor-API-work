...
//-----------------------------------------------------------------------------
//----- CmdHandler4.cpp : Implementation of CCmdHandler4
//-----------------------------------------------------------------------------
#include "StdAfx.h"
...
//-----------------------------------------------------------------------------
STDMETHODIMP CCmdHandler4::OnExecute(NameValueMap* context) {

	CWindow win;		
	win.Attach(m_ParentHwnd);
	win.MessageBox(_T("You clicked Command4 button"), _T("Command4 Implementation"));	
	return S_OK;
}