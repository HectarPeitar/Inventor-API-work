...
#if !defined(AFX_INSERTCATALOGPART_H__04859839_A5FA_11D3_B799_0060B0F159EF__INCLUDED_)
#define AFX_INSERTCATALOGPART_H__04859839_A5FA_11D3_B799_0060B0F159EF__INCLUDED_
...
/*--------------------- CInsertCatalogPartApp class declaration -------------------------------*/

class CInsertCatalogPartApp : public CWinApp
{
public:
...
// Overrides
	...
	//{{AFX_VIRTUAL(CInsertCatalogPartApp)
	public:
	virtual BOOL InitInstance();
	//}}AFX_VIRTUAL

	//{{AFX_MSG(CInsertCatalogPartApp)
...
/*--------------------- CInsertCatalogPartFactory class declaration -------------------------------*/

/*
 * The COM Class Factory class that is used by COM at CoCreation time to create the
 * CInsertCatalogPart object through its CreateInstance method. The CInsertCatalogPart object
 * is the object that is the first point of communication with Autodesk Inventor (R).
 */

class CInsertCatalogPartFactory : public IClassFactory
{
...
#endif // !defined(AFX_INSERTCATALOGPART_H__04859839_A5FA_11D3_B799_0060B0F159EF__INCLUDED_)
