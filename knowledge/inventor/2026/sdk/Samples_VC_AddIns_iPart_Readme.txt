...
15) Create loft between ellipses (step 5) and sketchCircle using rail collection(step 9).
  ...
  1) Copy Autodesk.iPart.Inventor.addin into ...\Autodesk\Inventor 20XX\Addins folder.
  ...
  2) Copy bin\iPart.dll into Inventor bin folder(For example: C:\Program Files\Autodesk\Inventor 20XX\Bin).
