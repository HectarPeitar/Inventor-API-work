...
//-----------------------------------------------------------------------------
//----- loftWithRailingsApp.h
//-----------------------------------------------------------------------------
#ifndef _loftWithRailings_h_
#define _loftWithRailings_h_

//-----------------------------------------------------------------------------
class CloftWithRailingsApp : public CWinApp {

public:
	//{{AFX_VIRTUAL(CloftWithRailingsApp)
	public:
    virtual BOOL InitInstance();
    virtual int ExitInstance();
	//}}AFX_VIRTUAL

	//{{AFX_MSG(CloftWithRailingsApp)
	//}}AFX_MSG
