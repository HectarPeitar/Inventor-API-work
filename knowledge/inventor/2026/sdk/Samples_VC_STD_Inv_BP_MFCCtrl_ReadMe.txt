========================================================================
		ActiveX Control DLL : SIMPLEMFCCONTROL
========================================================================

ControlWizard has created this project for your SIMPLEMFCCONTROL ActiveX Control
...
that make up your SIMPLEMFCCONTROL ActiveX Control DLL.

SIMPLEMFCCONTROL.dsp
...
SIMPLEMFCCONTROL.odl
	This file contains the Object Description Language source code for the
	type library of your control.

/////////////////////////////////////////////////////////////////////////////
SIMPLEMFCCONTROL control:

SIMPLEMFCCONTROLCtl.h
	This file contains the declaration of the CSIMPLEMFCCONTROLCtrl C++ class.

SIMPLEMFCCONTROLCtl.cpp
	This file contains the implementation of the CSIMPLEMFCCONTROLCtrl C++ class.

SIMPLEMFCCONTROLPpg.h
	This file contains the declaration of the CSIMPLEMFCCONTROLPropPage C++ class.

SIMPLEMFCCONTROLPpg.cpp
	This file contains the implementation of the CSIMPLEMFCCONTROLPropPage C++ class.

SIMPLEMFCCONTROLCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CSIMPLEMFCCONTROLCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file SIMPLEMFCCONTROL.rc.
