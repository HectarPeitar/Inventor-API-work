...
public:
	//----- AssemblyEventsSink
	STDMETHOD(OnAssemblyChange) (AssemblyDocument *pDocumentObject, NameValueMap *pContext, EventTimingEnum BeforeOrAfter, HandlingCodeEnum *pHandlingCode) ;
	STDMETHOD(OnNewOccurrence) (AssemblyDocument *pDocumentObject, ComponentOccurrence *pOccurrence, EventTimingEnum BeforeOrAfter, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;
	STDMETHOD(OnOccurrenceChange) (AssemblyDocument *pDocumentObject, ComponentOccurrence *pOccurrence, EventTimingEnum BeforeOrAfter, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;
	...
	STDMETHOD(OnNewRelationship) (AssemblyDocument *pDocumentObject, IDispatch *pRelationship, EventTimingEnum BeforeOrAfter, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;

	BEGIN_SINK_MAP([!output CLASS_NAME])
		SINK_ENTRY_EX (0, DIID_AssemblyEventsSink, AssemblyEventsSink_OnAssemblyChangeMeth, OnAssemblyChange)
		SINK_ENTRY_EX (0, DIID_AssemblyEventsSink, AssemblyEventsSink_OnNewOccurrenceMeth, OnNewOccurrence)
		SINK_ENTRY_EX (0, DIID_AssemblyEventsSink, AssemblyEventsSink_OnOccurrenceChangeMeth, OnOccurrenceChange)
		SINK_ENTRY_EX (0, DIID_AssemblyEventsSink, AssemblyEventsSink_OnDeleteMeth, OnDelete)
		SINK_ENTRY_EX (0, DIID_AssemblyEventsSink, AssemblyEventsSink_OnNewRelationshipMeth, OnNewRelationship)
		SINK_ENTRY_EX (0, DIID_AssemblyEventsSink, AssemblyEventsSink_OnLoadStateChangeMeth, OnLoadStateChange)
	END_SINK_MAP()
