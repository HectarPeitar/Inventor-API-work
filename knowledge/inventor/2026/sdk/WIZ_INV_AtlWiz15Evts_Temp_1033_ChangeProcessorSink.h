...
public:
	//----- ChangeProcessorSink
	STDMETHOD(OnExecute) (Document *pDocument, NameValueMap *pContext, VARIANT_BOOL Succeeded) ;
	STDMETHOD(OnReadFromScript) (Document *pDocument, string *pInputs, NameValueMap *pContext) ;
	STDMETHOD(OnTerminate) () ;
	STDMETHOD(OnWriteToScript) (Document *pDocument, NameValueMap *pContext, string *pResultInputs) ;

	BEGIN_SINK_MAP([!output CLASS_NAME])
		SINK_ENTRY_EX (0, DIID_ChangeProcessorSink, ChangeProcessorSink_OnExecute, OnExecute)
		SINK_ENTRY_EX (0, DIID_ChangeProcessorSink, ChangeProcessorSink_OnReadFromScript, OnReadFromScript)
		SINK_ENTRY_EX (0, DIID_ChangeProcessorSink, ChangeProcessorSink_OnTerminate, OnTerminate)
		SINK_ENTRY_EX (0, DIID_ChangeProcessorSink, ChangeProcessorSink_OnWriteToScript, OnWriteToScript)
	END_SINK_MAP()
