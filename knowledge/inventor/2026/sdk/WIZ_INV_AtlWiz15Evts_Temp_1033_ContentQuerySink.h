...
public:
	//----- ContentQuerySink
	STDMETHOD(OnCancel) () ;
	STDMETHOD(OnDone) (BSTR ResultXML) ;

	BEGIN_SINK_MAP([!output CLASS_NAME])
		SINK_ENTRY_EX (0, DIID_ContentQuerySink, ContentQuerySink_OnCancelMeth, OnCancel)
		SINK_ENTRY_EX (0, DIID_ContentQuerySink, ContentQuerySink_OnDoneMeth, OnDone)
	END_SINK_MAP()
