...
public:
	//----- DockableWindowsEventsSink
	STDMETHOD(OnHelp) (DockableWindow *pDockableWindow, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;
	STDMETHOD(OnHide) (DockableWindow *pDockableWindow, EventTimingEnum BeforeOrAfter, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;
	STDMETHOD(OnShow) (DockableWindow *pDockableWindow, EventTimingEnum BeforeOrAfter, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;

	BEGIN_SINK_MAP([!output CLASS_NAME])
		SINK_ENTRY_EX (0, DIID_DockableWindowsEventsSink, DockableWindowsEventsSink_OnHelpMeth, OnHelp)
		SINK_ENTRY_EX (0, DIID_DockableWindowsEventsSink, DockableWindowsEventsSink_OnHideMeth, OnHide)
		SINK_ENTRY_EX (0, DIID_DockableWindowsEventsSink, DockableWindowsEventsSink_OnShowMeth, OnShow)
	END_SINK_MAP()
