...
//-----------------------------------------------------------------------------
STDMETHODIMP [!output CLASS_NAME]::OnViewUpdate (EventTimingEnum BeforeOrAfter, NameValueMap *pContext, CommandTypesEnum *pReasonsForChange, HandlingCodeEnum *pHandlingCode)
{
