...
public:
	//----- DriveConstraintSettingsSink
	STDMETHOD(OnCollision) () ;

	BEGIN_SINK_MAP([!output CLASS_NAME])
		SINK_ENTRY_EX (0, DIID_DriveConstraintSettingsSink, DriveConstraintSettingsSink_OnCollisionMeth, OnCollision)
	END_SINK_MAP()
