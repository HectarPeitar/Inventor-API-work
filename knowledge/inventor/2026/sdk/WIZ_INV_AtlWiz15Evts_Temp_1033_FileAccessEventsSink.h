...
public:
	//----- FileAccessEventsSink
	STDMETHOD(OnFileResolution) (BSTR RelativeFileName, BSTR LibraryName, SAFEARRAY *pCustomLogicalName, EventTimingEnum BeforeOrAfter, NameValueMap *pContext, BSTR *pFullFileName, HandlingCodeEnum *pHandlingCode) ;
	STDMETHOD(OnFileDirty) (BSTR RelativeFileName, BSTR LibraryName, SAFEARRAY *pCustomLogicalName, BSTR FullFileName, Document *pDocumentObject, EventTimingEnum BeforeOrAfter, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;

	BEGIN_SINK_MAP([!output CLASS_NAME])
		SINK_ENTRY_EX (0, DIID_FileAccessEventsSink, FileAccessEventsSink_OnFileResolution, OnFileResolution)
		SINK_ENTRY_EX (0, DIID_FileAccessEventsSink, FileAccessEventsSink_OnFileDirty, OnFileDirty)
	END_SINK_MAP()
