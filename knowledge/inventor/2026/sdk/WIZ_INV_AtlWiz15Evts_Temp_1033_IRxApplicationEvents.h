...
public:
	...
	STDMETHOD(OnNewDocument)(Document *pDocumentObject) ;
	STDMETHOD(OnOpenDocument)(Document *pDocumentObject) ;
	STDMETHOD(OnSaveDocument)(Document *pDocumentObject, EventTimingEnum BeforeOrAfter) ;
	STDMETHOD(OnCloseDocument)(Document *pDocumentObject, EventTimingEnum BeforeOrAfter) ;
	STDMETHOD(OnActivateDocument)(Document *pDocumentObject) ;
	STDMETHOD(OnDeactivateDocument)(Document *pDocumentObject) ;
	STDMETHOD(OnNewView)(View *pViewObject) ;
	STDMETHOD(OnCloseView)(View *pViewObject) ;
	STDMETHOD(OnActivateView)(View *pViewObject) ;
	STDMETHOD(OnDeactivateView)(View *pViewObject) ;
	STDMETHOD(OnQuit)() ;
