...
public:
	//----- IRxFileUIEvents
	STDMETHOD(OnFileNewDialog) (BSTR TemplateDir, long ParentHWND, BSTR *pTemplateFileName, HandlingCodeEnum *pHandlingCode) ;
	STDMETHOD(OnFileOpenDialog) (SAFEARRAY **ppFileTypes, long ParentHWND, BSTR *pFileName, HandlingCodeEnum *pHandlingCode) ;
	STDMETHOD(OnFileSaveAsDialog) (SAFEARRAY **ppFileTypes, VARIANT_BOOL SaveCopyAs, long ParentHWND, BSTR *pFileName, HandlingCodeEnum *pHandlingCode) ;
	STDMETHOD(OnFileInsertNewDialog) (BSTR TemplateDir, SAFEARRAY **ppFileTypes, Document *DocumentObject, long ParentHWND, BSTR *pTemplateFileName, BSTR *pFileName, BSTR *pRelativeFileName, BSTR *LibraryName, SAFEARRAY **ppCustomLogicalName, HandlingCodeEnum *pHandlingCode) ;
	STDMETHOD(OnFileInsertDialog) (SAFEARRAY **ppFileTypes, Document *pDocumentObject, long ParentHWND, BSTR *pFileName, BSTR *pRelativeFileName, BSTR *pLibraryName, SAFEARRAY **ppCustomLogicalName, HandlingCodeEnum *pHandlingCode) ;
