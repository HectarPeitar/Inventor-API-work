...
public:
	//----- IRxTransactionEvents
	STDMETHOD(OnCommit) (Transaction *pTransactionObject, EventTimingEnum BeforeOrAfter, HandlingCodeEnum *pHandlingCode) ;
	STDMETHOD(OnUndo) (Transaction *pTransactionObject, EventTimingEnum BeforeOrAfter, HandlingCodeEnum *pHandlingCode) ;
	STDMETHOD(OnRedo) (Transaction *pTransactionObject, EventTimingEnum BeforeOrAfter, HandlingCodeEnum *pHandlingCode) ;
	STDMETHOD(OnAbort) (Transaction *pTransactionObject, EventTimingEnum BeforeOrAfter) ;
	STDMETHOD(OnDelete) (Transaction *pTransactionObject, EventTimingEnum BeforeOrAfter) ;
