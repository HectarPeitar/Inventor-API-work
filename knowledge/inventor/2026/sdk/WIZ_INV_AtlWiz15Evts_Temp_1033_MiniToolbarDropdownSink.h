...
public:
	...
	BEGIN_SINK_MAP([!output CLASS_NAME])
		SINK_ENTRY_EX (0, DIID_MiniToolbarDropdownSink, MiniToolbarDropdownSink_OnPreMenuDisplayMeth, OnPreMenuDisplay)
		SINK_ENTRY_EX (0, DIID_MiniToolbarDropdownSink, MiniToolbarDropdownSink_OnSelectMeth, OnSelect)
		SINK_ENTRY_EX (0, DIID_MiniToolbarDropdownSink, MiniToolbarDropdownSink_OnItemRemoveMeth, OnItemRemove)
		SINK_ENTRY_EX (0, DIID_MiniToolbarDropdownSink, MiniToolbarDropdownSink_OnItemHoverEndMeth, OnItemHoverEnd)
		SINK_ENTRY_EX (0, DIID_MiniToolbarDropdownSink, MiniToolbarDropdownSink_OnItemHoverStartMeth, OnItemHoverStart)
	END_SINK_MAP()
