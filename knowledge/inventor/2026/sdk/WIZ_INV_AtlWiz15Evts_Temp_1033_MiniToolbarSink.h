...
public:
	...
	BEGIN_SINK_MAP([!output CLASS_NAME])
		SINK_ENTRY_EX (0, DIID_MiniToolbarSink, MiniToolbarSink_OnApplyMeth, OnApply)
		SINK_ENTRY_EX (0, DIID_MiniToolbarSink, MiniToolbarSink_OnCancelMeth, OnCancel)
		SINK_ENTRY_EX (0, DIID_MiniToolbarSink, MiniToolbarSink_OnOKMeth, OnOK)
	END_SINK_MAP()
