...
public:
	//----- MouseEventsSink
	STDMETHOD(OnMouseUp) (MouseButtonEnum Button, ShiftStateEnum ShiftKeys, Point *pModelPosition, Point2d *pViewPosition, View *pView) ;
	STDMETHOD(OnMouseDown) (MouseButtonEnum Button, ShiftStateEnum ShiftKeys, Point *pModelPosition, Point2d *pViewPosition, View *pView) ;
	STDMETHOD(OnMouseClick) (MouseButtonEnum Button, ShiftStateEnum ShiftKeys, Point *pModelPosition, Point2d *pViewPosition, View *pView) ;
	STDMETHOD(OnMouseDoubleClick) (MouseButtonEnum Button, ShiftStateEnum ShiftKeys, Point *pModelPosition, Point2d *pViewPosition, View *pView) ;
	STDMETHOD(OnMouseMove) (MouseButtonEnum Button, ShiftStateEnum ShiftKeys, Point *pModelPosition, Point2d *pViewPosition, View *pView) ;
	STDMETHOD(OnMouseLeave) (MouseButtonEnum Button, ShiftStateEnum ShiftKeys, View *pView) ;

	BEGIN_SINK_MAP([!output CLASS_NAME])
		SINK_ENTRY_EX (0, DIID_MouseEventsSink, MouseEventsSink_OnMouseUpMeth, OnMouseUp)
		SINK_ENTRY_EX (0, DIID_MouseEventsSink, MouseEventsSink_OnMouseDownMeth, OnMouseDown)
		SINK_ENTRY_EX (0, DIID_MouseEventsSink, MouseEventsSink_OnMouseClickMeth, OnMouseClick)
		SINK_ENTRY_EX (0, DIID_MouseEventsSink, MouseEventsSink_OnMouseDoubleClickMeth, OnMouseDoubleClick)
		SINK_ENTRY_EX (0, DIID_MouseEventsSink, MouseEventsSink_OnMouseMoveMeth, OnMouseMove)
		SINK_ENTRY_EX (0, DIID_MouseEventsSink, MouseEventsSink_OnMouseLeaveMeth, OnMouseLeave)
	END_SINK_MAP()
