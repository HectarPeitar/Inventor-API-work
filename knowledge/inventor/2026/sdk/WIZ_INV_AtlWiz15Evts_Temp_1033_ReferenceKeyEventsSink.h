...
public:
	//----- ReferenceKeyEventsSink
	STDMETHOD(OnBindKeyToObject) (SAFEARRAY *pReferenceKey, IDispatch *pDocument, IDispatch **ppObject, SolutionNatureEnum *pMatchType, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;

	BEGIN_SINK_MAP([!output CLASS_NAME])
		SINK_ENTRY_EX (0, DIID_ReferenceKeyEventsSink, ReferenceKeyEventsSink_OnBindKeyToObjectMeth, OnBindKeyToObject)
	END_SINK_MAP()
