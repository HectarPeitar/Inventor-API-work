...
public:
	//----- SketchEventsSink
	STDMETHOD(OnNewSketch) (Document *pDocumentObject, Sketch *pSketch, EventTimingEnum BeforeOrAfter, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;
	STDMETHOD(OnSketchChange) (Document *pDocumentObject, Sketch *pSketch, EventTimingEnum BeforeOrAfter, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;
	STDMETHOD(OnNewSketch3D) (Document *pDocumentObject, Sketch3D *pSketch3D, EventTimingEnum BeforeOrAfter, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;
	STDMETHOD(OnSketch3DChange) (Document *pDocumentObject, Sketch3D *pSketch3D, EventTimingEnum BeforeOrAfter, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;
	STDMETHOD(OnSketch3DSolve) (Document *pDocumentObject, IDispatch *pSketch, EventTimingEnum BeforeOrAfter, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;
	...
	BEGIN_SINK_MAP([!output CLASS_NAME])
		SINK_ENTRY_EX (0, DIID_SketchEventsSink, SketchEventsSink_OnNewSketchMeth, OnNewSketch)
		SINK_ENTRY_EX (0, DIID_SketchEventsSink, SketchEventsSink_OnSketchChangeMeth, OnSketchChange)
		SINK_ENTRY_EX (0, DIID_SketchEventsSink, SketchEventsSink_OnNewSketch3DMeth, OnNewSketch3D)
		SINK_ENTRY_EX (0, DIID_SketchEventsSink, SketchEventsSink_OnSketch3DChangeMeth, OnSketch3DChange)
		SINK_ENTRY_EX (0, DIID_SketchEventsSink, SketchEventsSink_OnSketch3DSolveMeth, OnSketch3DSolve)
		SINK_ENTRY_EX (0, DIID_SketchEventsSink, SketchEventsSink_OnDeleteMeth, OnDelete)
	END_SINK_MAP()
