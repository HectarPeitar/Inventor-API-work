...
public:
	//----- TransactionEventsSink
	STDMETHOD(OnCommit) (Transaction *pTransactionObject, TransactionEventContext *pContext, EventTimingEnum BeforeOrAfter, HandlingCodeEnum *pHandlingCode) ;
	STDMETHOD(OnUndo) (Transaction *pTransactionObject, TransactionEventContext *pContext, EventTimingEnum BeforeOrAfter, HandlingCodeEnum *pHandlingCode) ;
	STDMETHOD(OnRedo) (Transaction *pTransactionObject, TransactionEventContext *pContext, EventTimingEnum BeforeOrAfter, HandlingCodeEnum *pHandlingCode) ;
	STDMETHOD(OnAbort) (Transaction *pTransactionObject, TransactionEventContext *pContext, EventTimingEnum BeforeOrAfter) ;
	STDMETHOD(OnDelete) (Transaction *pTransactionObject, TransactionEventContext *pContext, EventTimingEnum BeforeOrAfter) ;

	BEGIN_SINK_MAP([!output CLASS_NAME])
		SINK_ENTRY_EX (0, DIID_TransactionEventsSink, TransactionEventsSink_OnCommitMeth, OnCommit)
		SINK_ENTRY_EX (0, DIID_TransactionEventsSink, TransactionEventsSink_OnUndoMeth, OnUndo)
		SINK_ENTRY_EX (0, DIID_TransactionEventsSink, TransactionEventsSink_OnRedoMeth, OnRedo)
		SINK_ENTRY_EX (0, DIID_TransactionEventsSink, TransactionEventsSink_OnAbortMeth, OnAbort)
		SINK_ENTRY_EX (0, DIID_TransactionEventsSink, TransactionEventsSink_OnDeleteMeth, OnDelete)
	END_SINK_MAP()
