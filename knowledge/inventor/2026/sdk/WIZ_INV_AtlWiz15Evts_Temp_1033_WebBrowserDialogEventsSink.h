...
public:
	//----- WebBrowserDialogEventsSink
	STDMETHOD(OnClose) (EventTimingEnum BeforeOrAfter, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;
	STDMETHOD(OnHelp) (NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;

	BEGIN_SINK_MAP([!output CLASS_NAME])
		SINK_ENTRY_EX (0, DIID_WebBrowserDialogEventsSink, WebBrowserDialogEventsSink_OnCloseMeth, OnClose)
		SINK_ENTRY_EX (0, DIID_WebBrowserDialogEventsSink, WebBrowserDialogEventsSink_OnHelpMeth, OnHelp)
	END_SINK_MAP()
