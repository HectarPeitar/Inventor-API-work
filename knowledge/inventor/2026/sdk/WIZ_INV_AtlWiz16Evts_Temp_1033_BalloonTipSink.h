...
public:
	//----- BalloonTipSink
	STDMETHOD(OnClick) (NameValueMap *pContext) ;
	STDMETHOD(OnDisplay) (VARIANT_BOOL *pCancel) ;

	BEGIN_SINK_MAP([!output CLASS_NAME])
		SINK_ENTRY_EX (0, DIID_BalloonTipSink, BalloonTipSink_OnClickMeth, OnClick)
		SINK_ENTRY_EX (0, DIID_BalloonTipSink, BalloonTipSink_OnDisplayMeth, OnDisplay)
	END_SINK_MAP()
