...
public:
	//----- BrowserPanesSink
	STDMETHOD(OnBrowserNodeActivate) (IDispatch *pBrowserNodeDefinition, NameValueMap *pContext) ;
	STDMETHOD(OnBrowserNodeGetDisplayObjects) (IDispatch *pBrowserNodeDefinition, ObjectCollection **ppObjects, NameValueMap *pContext) ;
	STDMETHOD(OnBrowserNodeLabelEdit) (IDispatch *pBrowserNodeDefinition, BSTR NewLabel, EventTimingEnum BeforeOrAfter, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;
	STDMETHOD(OnBrowserNodeDeleteEntry) (IDispatch *pBrowserNodeDefinition, EventTimingEnum BeforeOrAfter, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;

	BEGIN_SINK_MAP([!output CLASS_NAME])
		SINK_ENTRY_EX (0, DIID_BrowserPanesSink, BrowserPanesSink_OnBrowserNodeActivateMeth, OnBrowserNodeActivate)
		SINK_ENTRY_EX (0, DIID_BrowserPanesSink, BrowserPanesSink_OnBrowserNodeGetDisplayObjectsMeth, OnBrowserNodeGetDisplayObjects)
		SINK_ENTRY_EX (0, DIID_BrowserPanesSink, BrowserPanesSink_OnBrowserNodeLabelEditMeth, OnBrowserNodeLabelEdit)
		SINK_ENTRY_EX (0, DIID_BrowserPanesSink, BrowserPanesSink_OnBrowserNodeDeleteEntryMeth, OnBrowserNodeDeleteEntry)
	END_SINK_MAP()
