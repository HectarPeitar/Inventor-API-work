...
//-----------------------------------------------------------------------------
STDMETHODIMP [!output CLASS_NAME]::OnExecute (Document *pDocument, NameValueMap *pContext, VARIANT_BOOL Succeeded)
{
	//----- Add your code here.
...
//-----------------------------------------------------------------------------
STDMETHODIMP [!output CLASS_NAME]::OnReadFromScript (Document *pDocument, string *pInputs, NameValueMap *pContext) 
{
	//----- Add your code here.
...
//-----------------------------------------------------------------------------
STDMETHODIMP [!output CLASS_NAME]::OnTerminate ()
{
	//----- Add your code here.
...
//-----------------------------------------------------------------------------
STDMETHODIMP [!output CLASS_NAME]::OnWriteToScript (Document *pDocument, NameValueMap *pContext, string *pResultInputs)
{
	//----- Add your code here.
