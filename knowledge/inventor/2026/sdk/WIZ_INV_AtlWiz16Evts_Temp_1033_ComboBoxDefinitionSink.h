...
public:
	//----- ComboBoxDefinitionSink
	STDMETHOD(OnSelect) (NameValueMap *pContext) ;
	STDMETHOD(OnHelp) (NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;

	BEGIN_SINK_MAP([!output CLASS_NAME])
		SINK_ENTRY_EX (0, DIID_ComboBoxDefinitionSink, ComboBoxDefinitionSink_OnSelectMeth, OnSelect)
		SINK_ENTRY_EX (0, DIID_ComboBoxDefinitionSink, ComboBoxDefinitionSink_OnHelpMeth, OnHelp)
	END_SINK_MAP()
