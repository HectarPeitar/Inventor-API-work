...
//-----------------------------------------------------------------------------
STDMETHODIMP [!output CLASS_NAME]::OnSelect (NameValueMap *pContext, NameValueMap *pOptions, BSTR *pResultXML) {
	if ( pResultXML == NULL )
		return (E_POINTER) ;
	//----- Add your code here.
...
//-----------------------------------------------------------------------------
STDMETHODIMP [!output CLASS_NAME]::OnSelectionCommit (NameValueMap *pContext, NameValueMap *pOptions, BSTR *pResultXML) {
	if ( pResultXML == NULL )
		return (E_POINTER) ;
	//----- Add your code here.
...
//-----------------------------------------------------------------------------
STDMETHODIMP [!output CLASS_NAME]::OnTerminate (VARIANT_BOOL Cancelled, NameValueMap *pContext) {
	//----- Add your code here.
