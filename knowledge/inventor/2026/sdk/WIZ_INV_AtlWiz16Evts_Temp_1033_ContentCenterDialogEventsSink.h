...
public:
	//----- ContentCenterDialogEventsSink
	STDMETHOD(OnSelect) (NameValueMap *pContext, NameValueMap *pOptions, BSTR *pResultXML) ;
	STDMETHOD(OnSelectionCommit) (NameValueMap *pContext, NameValueMap *pOptions, BSTR *pResultXML) ;
	STDMETHOD(OnTerminate) (VARIANT_BOOL Cancelled, NameValueMap *pContext) ;

	BEGIN_SINK_MAP([!output CLASS_NAME])
		SINK_ENTRY_EX (0, DIID_ContentCenterDialogEventsSink, ContentCenterDialogEventsSink_OnSelectMeth, OnSelect)
		SINK_ENTRY_EX (0, DIID_ContentCenterDialogEventsSink, ContentCenterDialogEventsSink_OnSelectionCommitMeth, OnSelectionCommit)
		SINK_ENTRY_EX (0, DIID_ContentCenterDialogEventsSink, ContentCenterDialogEventsSink_OnTerminateMeth, OnTerminate)
	END_SINK_MAP()
