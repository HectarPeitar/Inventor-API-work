...
//-----------------------------------------------------------------------------
STDMETHODIMP [!output CLASS_NAME]::OnHelp (DockableWindow *pDockableWindow, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode)
{
...
//-----------------------------------------------------------------------------
STDMETHODIMP [!output CLASS_NAME]::OnHide (DockableWindow *pDockableWindow, EventTimingEnum BeforeOrAfter, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode)
{
	if ( pHandlingCode == NULL )
		return (E_POINTER) ;
	//----- Add your code here.
...
//-----------------------------------------------------------------------------
STDMETHODIMP [!output CLASS_NAME]::OnShow (DockableWindow *pDockableWindow, EventTimingEnum BeforeOrAfter, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode)
{
	if ( pHandlingCode == NULL )
		return (E_POINTER) ;
	//----- Add your code here.
