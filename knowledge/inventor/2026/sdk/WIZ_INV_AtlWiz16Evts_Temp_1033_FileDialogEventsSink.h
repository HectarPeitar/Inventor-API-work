...
public:
	//----- FileDialogEventsSink
	STDMETHOD(OnOptions) (NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;

	BEGIN_SINK_MAP([!output CLASS_NAME])
		SINK_ENTRY_EX (0, DIID_FileDialogEventsSink, FileDialogEventsSink_OnOptions, OnOptions)
		SINK_ENTRY_EX (0, DIID_FileDialogEventsSink, FileDialogEventsSink_OnOptionsReset, OnOptionsReset)
	END_SINK_MAP()
