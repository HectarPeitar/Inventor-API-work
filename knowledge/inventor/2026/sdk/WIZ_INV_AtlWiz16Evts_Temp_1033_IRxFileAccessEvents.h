...
public:
	//----- IRxFileAccessEvents
	STDMETHOD(OnFileResolution) (BSTR RelativeFileName, BSTR LibraryName, SAFEARRAY **ppCustomLogicalName, BSTR *pFullFileName, HandlingCodeEnum *pHandlingCode) ;
	STDMETHOD(OnFileDirty) (BSTR RelativeFileName, BSTR LibraryName, SAFEARRAY **ppCustomLogicalName, BSTR FullFileName, Document *pDocumentObject, HandlingCodeEnum *pHandlingCode) ;
