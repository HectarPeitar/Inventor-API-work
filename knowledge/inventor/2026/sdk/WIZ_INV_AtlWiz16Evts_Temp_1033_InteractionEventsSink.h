...
public:
	...
	STDMETHOD(OnSuspend) () ;
	STDMETHOD(OnResume) () ;
	STDMETHOD(OnHelp) (EventTimingEnum BeforeOrAfter, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;

	BEGIN_SINK_MAP([!output CLASS_NAME])
		SINK_ENTRY_EX (0, DIID_InteractionEventsSink, InteractionEventsSink_OnActivateMeth, OnActivate)
		SINK_ENTRY_EX (0, DIID_InteractionEventsSink, InteractionEventsSink_OnTerminateMeth, OnTerminate)
		SINK_ENTRY_EX (0, DIID_InteractionEventsSink, InteractionEventsSink_OnSuspendMeth, OnSuspend)
		SINK_ENTRY_EX (0, DIID_InteractionEventsSink, InteractionEventsSink_OnResumeMeth, OnResume)
		SINK_ENTRY_EX (0, DIID_InteractionEventsSink, InteractionEventsSink_OnHelpMeth, OnHelp)
	END_SINK_MAP()
