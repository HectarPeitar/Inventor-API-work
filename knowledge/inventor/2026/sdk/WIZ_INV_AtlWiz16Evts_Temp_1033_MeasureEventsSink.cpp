...
//-----------------------------------------------------------------------------
STDMETHODIMP [!output CLASS_NAME]::OnMeasure (MeasureTypeEnum MeasureType, double MeasuredValue, NameValueMap *pContext)
{
	//----- Add your code here. 
...
//-----------------------------------------------------------------------------
STDMETHODIMP [!output CLASS_NAME]::OnSelectParameter (Parameter *pParameter, NameValueMap *pContext) 
{
	//----- Add your code here. 
