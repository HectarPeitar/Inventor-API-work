...
public:
	...
	STDMETHOD(OnNewParameter) (Document *pDocumentObject, Parameter *pParameter, EventTimingEnum BeforeOrAfter, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;
	STDMETHOD(OnParameterChange) (Document *pDocumentObject, Parameter *pParameter, EventTimingEnum BeforeOrAfter, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;
	STDMETHOD(OnClientFeatureDoubleClick) (Document *pDocumentObject, ClientFeature *pFeature, EventTimingEnum BeforeOrAfter, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;
	STDMETHOD(OnFeatureChange) (Document *pDocumentObject, PartFeature *pFeature, EventTimingEnum BeforeOrAfter, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;
	STDMETHOD(OnGenerateMember) (Document *pFactoryDocumentObject, BSTR *pMemberName, EventTimingEnum BeforeOrAfter, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;
	STDMETHOD(OnNewFeature) (Document *pDocumentObject, Feature *pFeature, EventTimingEnum BeforeOrAfter, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;

	BEGIN_SINK_MAP([!output CLASS_NAME])
		SINK_ENTRY_EX (0, DIID_ModelingEventsSink, ModelingEventsSink_OnDeleteMeth, OnDelete)
		SINK_ENTRY_EX (0, DIID_ModelingEventsSink, ModelingEventsSink_OnNewParameterMeth, OnNewParameter)
		SINK_ENTRY_EX (0, DIID_ModelingEventsSink, ModelingEventsSink_OnParameterChangeMeth, OnParameterChange)
		SINK_ENTRY_EX (0, DIID_ModelingEventsSink, ModelingEventsSink_OnClientFeatureDoubleClickMeth, OnClientFeatureDoubleClick)
		SINK_ENTRY_EX (0, DIID_ModelingEventsSink, ModelingEventsSink_OnFeatureChangeMeth, OnFeatureChange)
		SINK_ENTRY_EX (0, DIID_ModelingEventsSink, ModelingEventsSink_OnGenerateMemberMeth, OnGenerateMember)
		SINK_ENTRY_EX (0, DIID_ModelingEventsSink, ModelingEventsSink_OnNewFeatureMeth, OnNewFeature)
	END_SINK_MAP()
