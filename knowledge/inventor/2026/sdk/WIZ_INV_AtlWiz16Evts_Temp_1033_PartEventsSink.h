...
public:
	//----- ButtonDefinitionHandlerEventsSink
	STDMETHOD(OnSurfaceBodyChanged) (NameValueMap *pContext, EventTimingEnum BeforeOrAfter, HandlingCodeEnum *pHandlingCode) ;

	BEGIN_SINK_MAP([!output CLASS_NAME])
		SINK_ENTRY_EX (0, DIID_PartEventsSink, PartEventsSink_OnSurfaceBodyChangedMeth, OnSurfaceBodyChanged)
	END_SINK_MAP()
