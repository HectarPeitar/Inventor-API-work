...
public:
	//----- SearchBoxEventsSink
	STDMETHOD(OnStartSearch) (HandlingCodeEnum *pHandlingCode) ;
	STDMETHOD(OnEndSearch) (NameValueMap *pSearchResult,HandlingCodeEnum *pHandlingCode) ;
	STDMETHOD(OnStopSearch) (NameValueMap *pSearchResult,HandlingCodeEnum *pHandlingCode) ;
	STDMETHOD(OnClearSearch) (HandlingCodeEnum *pHandlingCode) ;
	
	BEGIN_SINK_MAP([!output CLASS_NAME])
		SINK_ENTRY_EX (0, DIID_SearchBoxEventsSink, SearchBoxEventsSink_OnStartSearchMeth, OnStartSearch)
		SINK_ENTRY_EX (0, DIID_SearchBoxEventsSink, SearchBoxEventsSink_OnEndSearchMeth, OnEndSearch)
		SINK_ENTRY_EX (0, DIID_SearchBoxEventsSink, SearchBoxEventsSink_OnStopSearchMeth, OnStopSearch)
		SINK_ENTRY_EX (0, DIID_SearchBoxEventsSink, SearchBoxEventsSink_OnClearSearchMeth, OnClearSearch)
	END_SINK_MAP()
