...
public:
	//----- StyleEventsSink
	STDMETHOD(OnDelete) (Document *pDocumentObject, IDispatch *pStyle, EventTimingEnum BeforeOrAfter, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;
	STDMETHOD(OnNewStyle) (Document *pDocumentObject, IDispatch *pStyle, EventTimingEnum BeforeOrAfter, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;
	STDMETHOD(OnActivateStyle) (Document *pDocumentObject, IDispatch *pStyle, EventTimingEnum BeforeOrAfter, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;
	STDMETHOD(OnStyleChange) (Document *pDocumentObject, IDispatch *pStyle, EventTimingEnum BeforeOrAfter, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;
	STDMETHOD(OnMigrateStyleLibrary) (BSTR LibraryPath, EventTimingEnum BeforeOrAfter, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;

	BEGIN_SINK_MAP([!output CLASS_NAME])
		SINK_ENTRY_EX (0, DIID_StyleEventsSink, StyleEventsSink_OnDeleteMeth, OnDelete)
		SINK_ENTRY_EX (0, DIID_StyleEventsSink, StyleEventsSink_OnNewStyleMeth, OnNewStyle)
		SINK_ENTRY_EX (0, DIID_StyleEventsSink, StyleEventsSink_OnActivateStyleMeth, OnActivateStyle)
		SINK_ENTRY_EX (0, DIID_StyleEventsSink, StyleEventsSink_OnStyleChangeMeth, OnStyleChange)
		SINK_ENTRY_EX (0, DIID_StyleEventsSink, StyleEventsSink_OnMigrateStyleLibraryMeth, OnMigrateStyleLibrary)
	END_SINK_MAP()
