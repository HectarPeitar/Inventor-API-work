...
public:
	...
	STDMETHOD(OnEnvironmentChange) (Environment *pEnvironment, EnvironmentStateEnum EnvironmentState, EventTimingEnum BeforeOrAfter, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;
	STDMETHOD(OnResetRibbonInterface) (NameValueMap *pContext) ;
	STDMETHOD(OnResetShortcuts) (NameValueMap *pContext) ;

	BEGIN_SINK_MAP([!output CLASS_NAME])
		SINK_ENTRY_EX (0, DIID_UserInterfaceEventsSink, UserInterfaceEventsSink_OnResetEnvironmentsMeth, OnResetEnvironments)
		SINK_ENTRY_EX (0, DIID_UserInterfaceEventsSink, UserInterfaceEventsSink_OnResetCommandBarsMeth, OnResetCommandBars)
		SINK_ENTRY_EX (0, DIID_UserInterfaceEventsSink, UserInterfaceEventsSink_OnEnvironmentChange, OnEnvironmentChange)
		SINK_ENTRY_EX (0, DIID_UserInterfaceEventsSink, UserInterfaceEventsSink_OnResetRibbonInterface, OnResetRibbonInterface)
		SINK_ENTRY_EX (0, DIID_UserInterfaceEventsSink, UserInterfaceEventsSink_OnResetShortcuts, OnResetShortcuts)
	END_SINK_MAP()
