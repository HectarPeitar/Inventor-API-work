...
public:
	...
	BEGIN_SINK_MAP([!output CLASS_NAME])
		SINK_ENTRY_EX (0, DIID_BrowserPaneSink, BrowserPaneSink_OnActivateMeth, OnActivate)
		SINK_ENTRY_EX (0, DIID_BrowserPaneSink, BrowserPaneSink_OnDeactivateMeth, OnDeactivate)
		SINK_ENTRY_EX (0, DIID_BrowserPaneSink, BrowserPaneSink_OnHelpMeth, OnHelp)
	END_SINK_MAP()
