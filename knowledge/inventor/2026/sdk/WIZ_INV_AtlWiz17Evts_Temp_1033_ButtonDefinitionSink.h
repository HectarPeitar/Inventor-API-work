...
public:
	...
	STDMETHOD(OnExecute) (NameValueMap *pContext) ;
	STDMETHOD(OnHelp) (NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;

	BEGIN_SINK_MAP([!output CLASS_NAME])
		SINK_ENTRY_EX (0, DIID_ButtonDefinitionSink, ButtonDefinitionSink_OnExecute, OnExecute)
		SINK_ENTRY_EX (0, DIID_ButtonDefinitionSink, ButtonDefinitionSink_OnHelpMeth, OnHelp)
	END_SINK_MAP()
