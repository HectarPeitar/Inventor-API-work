...
public:
	//----- CameraEventsSink
	STDMETHOD(OnCameraChange) (View *pView, EventTimingEnum BeforeOrAfter, NameValueMap *pContext) ;

	BEGIN_SINK_MAP([!output CLASS_NAME])
		SINK_ENTRY_EX (0, DIID_CameraEventsSink, CameraEventsSink_OnCameraChangeMeth, OnCameraChange)
	END_SINK_MAP()
