...
public:
	...
	STDMETHOD(OnReplay) (NameValueMap *pContext, ChangeProcessor *pResultProcessor) ;

	BEGIN_SINK_MAP([!output CLASS_NAME])
		SINK_ENTRY_EX (0, DIID_ChangeDefinitionSink, ChangeDefinitionSink_OnReplay, OnReplay)
	END_SINK_MAP()
