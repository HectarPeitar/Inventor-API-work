...
public:
	//----- DocumentEventsSink
	STDMETHOD(OnSave) (EventTimingEnum BeforeOrAfter, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;
	STDMETHOD(OnClose) (EventTimingEnum BeforeOrAfter, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;
	STDMETHOD(OnActivate) (EventTimingEnum BeforeOrAfter, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;
	STDMETHOD(OnDeactivate) (EventTimingEnum BeforeOrAfter, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;
	STDMETHOD(OnChangeSelectSet) (EventTimingEnum BeforeOrAfter, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;
	STDMETHOD(OnChange) (CommandTypesEnum ReasonsForChange, EventTimingEnum BeforeOrAfter, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;
	STDMETHOD(OnDelete) (IDispatch *pEntity, EventTimingEnum BeforeOrAfter, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;

	BEGIN_SINK_MAP([!output CLASS_NAME])
		SINK_ENTRY_EX (0, DIID_DocumentEventsSink, DocumentEventsSink_OnSave, OnSave)
		SINK_ENTRY_EX (0, DIID_DocumentEventsSink, DocumentEventsSink_OnClose, OnClose)
		SINK_ENTRY_EX (0, DIID_DocumentEventsSink, DocumentEventsSink_OnActivate, OnActivate)
		SINK_ENTRY_EX (0, DIID_DocumentEventsSink, DocumentEventsSink_OnDeactivate, OnDeactivate)
		SINK_ENTRY_EX (0, DIID_DocumentEventsSink, DocumentEventsSink_OnChangeSelectSet, OnChangeSelectSet)
		SINK_ENTRY_EX (0, DIID_DocumentEventsSink, DocumentEventsSink_OnChange, OnChange)
		SINK_ENTRY_EX (0, DIID_DocumentEventsSink, DocumentEventsSink_OnDelete, OnDelete)
	END_SINK_MAP()
