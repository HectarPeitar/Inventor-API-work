...
//-----------------------------------------------------------------------------
STDMETHODIMP [!output CLASS_NAME]::OnRetrieveDimensions (DrawingDocument *pDocumentObject, ObjectsEnumerator *pSketchDimensions, GeneralDimensionsEnumerator *pDrawingDimensions, EventTimingEnum BeforeOrAfter, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) {
