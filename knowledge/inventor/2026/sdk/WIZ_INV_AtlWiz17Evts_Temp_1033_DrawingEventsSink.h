...
public:
	//----- DrawingEventsSink
	STDMETHOD(OnRetrieveDimensions) (DrawingDocument *pDocumentObject, ObjectsEnumerator *pSketchDimensions, GeneralDimensionsEnumerator *pDrawingDimensions, EventTimingEnum BeforeOrAfter, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;

	BEGIN_SINK_MAP([!output CLASS_NAME])
		SINK_ENTRY_EX (0, DIID_DrawingEventsSink, DrawingEventsSink_OnRetrieveDimensionsMeth, OnRetrieveDimensions)
	END_SINK_MAP()
