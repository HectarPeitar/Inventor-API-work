...
public:
	//----- DrawingViewEventsSink
	STDMETHOD(OnViewUpdate) (EventTimingEnum BeforeOrAfter, NameValueMap *pContext, CommandTypesEnum *pReasonsForChange, HandlingCodeEnum *pHandlingCode) ;

	BEGIN_SINK_MAP([!output CLASS_NAME])
		SINK_ENTRY_EX (0, DIID_DrawingViewEventsSink, DrawingViewEventsSink_OnViewUpdate, OnViewUpdate)
	END_SINK_MAP()
