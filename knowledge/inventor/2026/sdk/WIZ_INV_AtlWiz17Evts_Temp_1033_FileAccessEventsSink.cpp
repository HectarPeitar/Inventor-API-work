...
//-----------------------------------------------------------------------------
STDMETHODIMP [!output CLASS_NAME]::OnFileResolution (BSTR RelativeFileName, BSTR LibraryName, SAFEARRAY *pCustomLogicalName, EventTimingEnum BeforeOrAfter, NameValueMap *pContext, BSTR *pFullFileName, HandlingCodeEnum *pHandlingCode) {
	if ( pFullFileName == NULL || pHandlingCode == NULL )
		return (E_POINTER) ;
	//----- Add your code here.
...
//-----------------------------------------------------------------------------
STDMETHODIMP [!output CLASS_NAME]::OnFileDirty (BSTR RelativeFileName, BSTR LibraryName, SAFEARRAY *pCustomLogicalName, BSTR FullFileName, Document *pDocumentObject, EventTimingEnum BeforeOrAfter, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) {
