...
//-----------------------------------------------------------------------------
STDMETHODIMP [!output CLASS_NAME]::OnFileDelete (BSTR FullFileName, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode)
{
...
//-----------------------------------------------------------------------------
STDMETHODIMP [!output CLASS_NAME]::OnFileCopy (BSTR SourceFullFileName, BSTR DestinationFullFileName, VARIANT_BOOL Copy, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode)
{
	if ( pHandlingCode == NULL )
		return (E_POINTER) ;
	//----- Add your code here.
