...
public:
	//----- FileManagerEventsSink
	STDMETHOD(OnFileDelete) (BSTR FullFileName, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;
	STDMETHOD(OnFileCopy) (BSTR SourceFullFileName, BSTR DestinationFullFileName, VARIANT_BOOL Copy, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;

	BEGIN_SINK_MAP([!output CLASS_NAME])
		SINK_ENTRY_EX (0, DIID_FileManagerEventsSink, FileManagerEventsSink_OnFileDelete, OnFileDelete)
		SINK_ENTRY_EX (0, DIID_FileManagerEventsSink, FileManagerEventsSink_OnFileCopy, OnFileCopy)
	END_SINK_MAP()
