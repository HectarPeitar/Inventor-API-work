...
public:
	//----- HelpEventsSink
	STDMETHOD(OnApplicationHelp) (NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;

	BEGIN_SINK_MAP([!output CLASS_NAME])
		SINK_ENTRY_EX (0, DIID_HelpEventsSink, HelpEventsSink_OnApplicationHelpMeth, OnApplicationHelp)
	END_SINK_MAP()
