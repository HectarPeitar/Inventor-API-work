...
//-----------------------------------------------------------------------------
STDMETHODIMP [!output CLASS_NAME]::OnFileResolution (BSTR RelativeFileName, BSTR LibraryName, SAFEARRAY **ppCustomLogicalName, BSTR *pFullFileName, HandlingCodeEnum *pHandlingCode)
{
...
//-----------------------------------------------------------------------------
STDMETHODIMP [!output CLASS_NAME]::OnFileDirty (BSTR RelativeFileName, BSTR LibraryName, SAFEARRAY **ppCustomLogicalName, BSTR FullFileName, Document *pDocumentObject, HandlingCodeEnum *pHandlingCode)
{
