...
//-----------------------------------------------------------------------------
STDMETHODIMP [!output CLASS_NAME]::OnKeyDown (long Key, ShiftStateEnum ShiftKeys) {
	//----- Add your code here.
...
//-----------------------------------------------------------------------------
STDMETHODIMP [!output CLASS_NAME]::OnKeyUp (long Key, ShiftStateEnum ShiftKeys) {
	//----- Add your code here.
...
//-----------------------------------------------------------------------------
STDMETHODIMP [!output CLASS_NAME]::OnKeyPress (long KeyASCII) {
	//----- Add your code here.
