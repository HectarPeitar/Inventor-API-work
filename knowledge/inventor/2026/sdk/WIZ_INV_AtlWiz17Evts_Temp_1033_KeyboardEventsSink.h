...
public:
	//----- KeyboardEventsSink
	STDMETHOD(OnKeyDown) (long Key, ShiftStateEnum ShiftKeys) ;
	STDMETHOD(OnKeyUp) (long Key, ShiftStateEnum ShiftKeys) ;
	STDMETHOD(OnKeyPress) (long KeyASCII) ;

	BEGIN_SINK_MAP([!output CLASS_NAME])
		SINK_ENTRY_EX (0, DIID_KeyboardEventsSink, KeyboardEventsSink_OnKeyDownMeth, OnKeyDown)
		SINK_ENTRY_EX (0, DIID_KeyboardEventsSink, KeyboardEventsSink_OnKeyUpMeth, OnKeyUp)
		SINK_ENTRY_EX (0, DIID_KeyboardEventsSink, KeyboardEventsSink_OnKeyPressMeth, OnKeyPress)
	END_SINK_MAP()
