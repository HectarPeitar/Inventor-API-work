...
public:
	//----- MeasureEventsSink
	STDMETHOD(OnMeasure) (MeasureTypeEnum MeasureType, double MeasuredValue, NameValueMap *pContext) ;
	STDMETHOD(OnSelectParameter) (Parameter *pParameter, NameValueMap *pContext) ;

	BEGIN_SINK_MAP([!output CLASS_NAME])
		SINK_ENTRY_EX (0, DIID_MeasureEventsSink, MeasureEventsSink_OnMeasure, OnMeasure)
		SINK_ENTRY_EX (0, DIID_MeasureEventsSink, MeasureEventsSink_OnSelectParameter, OnSelectParameter)
	END_SINK_MAP()
