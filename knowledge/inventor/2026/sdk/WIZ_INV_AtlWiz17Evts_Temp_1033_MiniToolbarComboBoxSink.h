...
public:
	//----- MiniToolbarComboBoxSink
	STDMETHOD(OnPreMenuDisplay) () ;
	...
	BEGIN_SINK_MAP([!output CLASS_NAME])
		SINK_ENTRY_EX (0, DIID_MiniToolbarComboBoxSink, MiniToolbarComboBoxSink_OnPreMenuDisplayMeth, OnPreMenuDisplay)
		SINK_ENTRY_EX (0, DIID_MiniToolbarComboBoxSink, MiniToolbarComboBoxSink_OnItemHoverEndMeth, OnItemHoverEnd)
		SINK_ENTRY_EX (0, DIID_MiniToolbarComboBoxSink, MiniToolbarComboBoxSink_OnItemHoverStartMeth, OnItemHoverStart)
		SINK_ENTRY_EX (0, DIID_MiniToolbarComboBoxSink, MiniToolbarComboBoxSink_OnItemRemoveMeth, OnItemRemove)
		SINK_ENTRY_EX (0, DIID_MiniToolbarComboBoxSink, MiniToolbarComboBoxSink_OnSelectMeth, OnSelect)
	END_SINK_MAP()
