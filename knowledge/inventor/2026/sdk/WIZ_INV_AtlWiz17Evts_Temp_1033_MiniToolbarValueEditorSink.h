...
public:
	//----- MiniToolbarValueEditorSink
	STDMETHOD(OnChange) () ;
	STDMETHOD(OnEnter) () ;
	STDMETHOD(OnExit) () ;

	BEGIN_SINK_MAP([!output CLASS_NAME])
		SINK_ENTRY_EX (0, DIID_MiniToolbarValueEditorSink, MiniToolbarValueEditorSink_OnChangeMeth, OnChange)
		SINK_ENTRY_EX (0, DIID_MiniToolbarValueEditorSink, MiniToolbarValueEditorSink_OnEnterMeth, OnEnter)
		SINK_ENTRY_EX (0, DIID_MiniToolbarValueEditorSink, MiniToolbarValueEditorSink_OnExitMeth, OnExit)
	END_SINK_MAP()
