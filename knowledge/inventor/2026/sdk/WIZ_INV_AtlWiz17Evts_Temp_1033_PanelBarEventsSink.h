...
public:
	//----- PanelBarEventsSink
	STDMETHOD(OnCommandBarSelection) (CommandBar *pCommandBarObject, EventTimingEnum BeforeOrAfter, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode) ;

	BEGIN_SINK_MAP([!output CLASS_NAME])
		SINK_ENTRY_EX (0, DIID_PanelBarEventsSink, PanelBarEventsSink_OnCommandBarSelectMeth, OnCommandBarSelection)
	END_SINK_MAP()
