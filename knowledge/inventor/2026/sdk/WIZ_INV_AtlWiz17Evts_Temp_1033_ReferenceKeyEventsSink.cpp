...
//-----------------------------------------------------------------------------
STDMETHODIMP [!output CLASS_NAME]::OnBindKeyToObject (SAFEARRAY *pReferenceKey, IDispatch *pDocument, IDispatch **ppObject, SolutionNatureEnum *pMatchType, NameValueMap *pContext, HandlingCodeEnum *pHandlingCode)
{
