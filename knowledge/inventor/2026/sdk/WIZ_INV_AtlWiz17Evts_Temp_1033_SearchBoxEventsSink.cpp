...
//-----------------------------------------------------------------------------
STDMETHODIMP [!output CLASS_NAME]::OnStartSearch (HandlingCodeEnum *pHandlingCode)
{
	//----- Add your code here.
...
//-----------------------------------------------------------------------------
STDMETHODIMP [!output CLASS_NAME]::OnEndSearch (NameValueMap *pSearchResult,HandlingCodeEnum *pHandlingCode)
{
	//----- Add your code here.
...
//-----------------------------------------------------------------------------
STDMETHODIMP [!output CLASS_NAME]::OnStopSearch (NameValueMap *pSearchResult,HandlingCodeEnum *pHandlingCode)
{
	//----- Add your code here.
...
//-----------------------------------------------------------------------------
STDMETHODIMP [!output CLASS_NAME]::OnClearSearch (HandlingCodeEnum *pHandlingCode)
{
	//----- Add your code here.
