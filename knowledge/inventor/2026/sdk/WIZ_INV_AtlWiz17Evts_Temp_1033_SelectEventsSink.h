...
public:
	//----- SelectEventsSink
	STDMETHOD(OnPreSelect) (IDispatch **ppPreSelectEntity, VARIANT_BOOL *pDoHighlight, ObjectCollection **ppMorePreSelectEntities, SelectionDeviceEnum SelectionDevice, Point *pModelPosition, Point2d *pViewPosition, View *pView) ;
	STDMETHOD(OnPreSelectMouseMove) (IDispatch *pPreSelectEntity, Point *pModelPosition, Point2d *pViewPosition, View *pView) ;
	STDMETHOD(OnStopPreSelect) (Point *pModelPosition, Point2d *pViewPosition, View *View) ;
	STDMETHOD(OnSelect) (ObjectsEnumerator *pJustSelectedEntities, SelectionDeviceEnum SelectionDevice, Point *pModelPosition, Point2d *pViewPosition, View *pView) ;
	STDMETHOD(OnUnSelect) (ObjectsEnumerator *pUnSelectedEntities, SelectionDeviceEnum SelectionDevice, Point *pModelPosition, Point2d *pViewPosition, View *pView) ;

	BEGIN_SINK_MAP([!output CLASS_NAME])
		SINK_ENTRY_EX (0, DIID_SelectEventsSink, SelectEventsSink_OnPreSelectMeth, OnPreSelect)
		SINK_ENTRY_EX (0, DIID_SelectEventsSink, SelectEventsSink_OnPreSelectMouseMoveMeth, OnPreSelectMouseMove)
		SINK_ENTRY_EX (0, DIID_SelectEventsSink, SelectEventsSink_OnStopPreSelectMeth, OnStopPreSelect)
		SINK_ENTRY_EX (0, DIID_SelectEventsSink, SelectEventsSink_OnSelectMeth, OnSelect)
		SINK_ENTRY_EX (0, DIID_SelectEventsSink, SelectEventsSink_OnUnSelectMeth, OnUnSelect)
	END_SINK_MAP()
